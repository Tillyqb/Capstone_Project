function NewPageProtector() {
  ...
  function newPageProtectorInfo(evt) {
    console.log('handleNewPageProtectorInfo is running');
    evt.preventDefault();
    ...
    fetch('/api/new-page-protector', options)
